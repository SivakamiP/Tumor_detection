...
image_dir = r'C:\Users\sivak\dl\deep-learning\CNN\tumor_detection\tumordata'  #change path
...
plt.savefig('C:/Users/sivak/dl/deep-learning/CNN/tumor_detection/results/tumor_sample_accuracy_plot.png')
...
plt.savefig('C:/Users/sivak/dl/deep-learning/CNN/tumor_detection/results/tumor_sample_loss_plot.png')
...
make_prediction(cv2.imread('C:\\Users\\sivak\\dl\\deep-learning\\CNN\\tumor_detection\\tumordata\\no\\no1.jpg'),model)
print("--------------------------------------\n")
make_prediction(cv2.imread('C:\\Users\\sivak\\dl\\deep-learning\\CNN\\tumor_detection\\tumordata\yes\y1.jpg'),model)
print("--------------------------------------\n")